...
public  class ExpandHighImage extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        getSupportActionBar().setTitle("High Image");
    ...
    private void setup(Context context) throws FileNotFoundException {
        ...
        String filename = getIntent().getStringExtra("highImageFilename");
